  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6 md:p-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="relative mb-12">
        <h2
          className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 top-0 text-4xl md:text-6xl font-black text-[#1e3a8a] uppercase tracking-tighter z-10 px-4"
          style={{ fontFamily: 'Fredoka One' }}
        >
          Pick Your Instrument
        </h2>
        <div className="pt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 grid-auto-rows-fr">
          {INSTRUMENTS.map((inst) => (
            ...
            >
              ...
              <span className="text-xl md:text-2xl font-black text-white uppercase tracking-tighter mt-auto">
                {inst.type}
              </span>
            </button>
          ))}
