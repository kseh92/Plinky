...
// --- SettingsScreen: Configuration for parents and kids ---
      ...
      <div className="space-y-10 text-left">
        ...
        <section className="bg-[#1e3a8a]/5 p-8 md:p-10 rounded-[4rem] border-[6px] border-white shadow-inner">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Volume Guard */}
            <div className="bg-white/80 p-6 rounded-[2.5rem] border-2 border-white flex items-center justify-between shadow-md min-h-[110px]">
              <div className="pr-4">
              ...
              <button 
                ...
                className={`w-16 h-8 rounded-full relative transition-colors flex-shrink-0 ${volumeGuard ? 'bg-green-400' : 'bg-gray-300'}`}
              >
            ...
            <div className="bg-white/80 p-6 rounded-[2.5rem] border-2 border-white flex items-center justify-between shadow-md min-h-[110px]">
              ...
              <select 
                ...
                className="bg-[#9ECAFF]/20 border-none rounded-xl font-black text-[#1e3a8a] p-2 text-sm focus:ring-2 focus:ring-[#1e3a8a] flex-shrink-0"
              >
            ...
            <div className="bg-white/80 p-6 rounded-[2.5rem] border-2 border-white flex items-center justify-between shadow-md min-h-[110px]">
              ...
              <button 
                ...
                className={`w-16 h-8 rounded-full relative transition-colors flex-shrink-0 ${privacyMode ? 'bg-green-400' : 'bg-gray-300'}`}
              >
            ...
            <div className="bg-white/80 p-6 rounded-[2.5rem] border-2 border-white flex items-center justify-between shadow-md min-h-[110px]">
              ...
              <button 
                ...
                className={`w-16 h-8 rounded-full relative transition-colors flex-shrink-0 ${gallerySharing ? 'bg-green-400' : 'bg-gray-300'}`}
              >
